...
public class MainActivity extends AppCompatActivity
    ...
    private static final int MATRIX_SIZE = 3;// задаем размер матрицы, можно ставить от 2 до 20))
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(ru.ponomarev.line.R.layout.activity_main);

        mGridLayout = findViewById(ru.ponomarev.line.R.id.my_grid);
        ...
        for (int yPos = 0; yPos < MATRIX_SIZE; yPos++) {
            for (int xPos = 0; xPos < MATRIX_SIZE; xPos++) {
                ...
                mBut.setTextColor(ContextCompat.getColor(this, ru.ponomarev.line.R.color.white));
                ...
                mBut.setBackgroundResource(ru.ponomarev.line.R.drawable.bg_grey);
        ...
        mUpText = findViewById(ru.ponomarev.line.R.id.upper_scoreboard);
        mLowText = findViewById(ru.ponomarev.line.R.id.lower_scoreboard);
    ...
    public void changeButtonBg(int y, int x, boolean row, boolean active) {
        ...
        if (active) {
            if (row)
                mButtons[y][x].setBackgroundResource(ru.ponomarev.line.R.drawable.bg_green);
            else
                mButtons[y][x].setBackgroundResource(ru.ponomarev.line.R.drawable.bg_red);

        } else {
            mButtons[y][x].setBackgroundResource(ru.ponomarev.line.R.drawable.bg_grey);
        }
    }
